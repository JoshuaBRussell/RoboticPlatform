...
plot(s_time,diff_p1_foot_velm(1080:1380)*p1impm(2),'g');
plot(s_time,diff_p1_foot_posm(1080:1380)*p1impm(1),'r');
plot(s_time,diff_p1_foot_accm(1080:1380)*(p1impm(3)),'b');
plot(s_time,diff_p1_foot_posm(1080:1380)*p1impm(1)+diff_p1_foot_velm(1080:1380)*p1impm(2)+diff_p1_foot_accm(1080:1380)*p1impm(3),'m');
ylim([-10 20])
