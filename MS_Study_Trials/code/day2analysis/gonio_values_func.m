function[y]=gonio_values_func(perturb)
...
% 3 is channel for foot and 6 for platform 
gonio=filtfilt(d1,Input1.data(:,3));
gonio=detrend(gonio,'Linear');
plot(gonio)
[a,b]=findpeaks(gonio);
...
[c,d]=findpeaks(encoder);
for i=1:length(gonio)-125
c_gonio(i)=gonio(i+125);
end
c_gonio=c_gonio-mean(c_gonio);
