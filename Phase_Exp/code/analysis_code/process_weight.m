...
ci1=prctile(weight_p1,[2.5 97.5]);
ci2=prctile(weight_p2,[2.5 97.5]);
ci3=prctile(weight_p3,[2.5 97.5]);
ci4=prctile(weight_p4,[2.5 97.5]);

CI_coeff1 = ci1(2) - mean(weight_p1);
CI_coeff2 = ci2(2) - mean(weight_p2);
CI_coeff3 = ci3(2) - mean(weight_p3);
CI_coeff4 = ci4(2) - mean(weight_p4);

weight_m = [mean(weight_p1), mean(weight_p2), mean(weight_p3), mean(weight_p4)];
weight_s = [CI_coeff1, CI_coeff2, CI_coeff3, CI_coeff4];
