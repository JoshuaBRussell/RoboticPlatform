...
for i=1:analysis_value-1
    ...
    %     p4imp(i,:)=regress(diff_p4_plat_torqueimp(i,120:320)',[diff_p4_foot_pos(i,120:320)' diff_p4_foot_vel(i,120:320)' diff_p4_foot_acc(i,120:320)']);
    C1=[diff_p4_foot_pos(i,120:320)' diff_p4_foot_vel(i,120:320)' diff_p4_foot_acc(i,120:320)'];
    d1=diff_p4_plat_torqueimp(i,120:320)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*lim;l_lim];
    ...
    vartor3=var(diff_p4_plat_torqueimp(i,120:320));
    varimp4=var(diff_p4_plat_torqueimp(i,120:320)-(diff_p4_foot_pos(i,120:320)*p4imp(i,1)+diff_p4_foot_vel(i,120:320)*p4imp(i,2)+diff_p4_foot_acc(i,120:320)*p4imp(i,3)));
    p4impg(i)=100*(1-(varimp4/vartor3));
    
end
p4impm=regress(diff_p4_plat_torqueimpm(120:320)',[diff_p4_foot_posm(120:320)' diff_p4_foot_velm(120:320)' diff_p4_foot_accm(120:320)']);
C=[diff_p4_foot_posm(120:320)' diff_p4_foot_velm(120:320)' diff_p4_foot_accm(120:320)'];
d=diff_p4_plat_torqueimpm(120:320)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*lim;l_lim];
...
for i=1:analysis_value-1
    ...
    C1=[diff_p5_foot_pos(i,120:320)' diff_p5_foot_vel(i,120:320)' ...
        diff_p5_foot_acc(i,120:320)'];
    d1=diff_p5_plat_torqueimp(i,120:320)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*lim;l_lim];
    ...
    vartor3=var(diff_p5_plat_torqueimp(i,120:320));
    varimp5=var(diff_p5_plat_torqueimp(i,120:320)-(diff_p5_foot_pos(i,...
        120:320)*p5imp(i,1)+diff_p5_foot_vel(i,120:320)*p5imp(i,2)+...
        diff_p5_foot_acc(i,120:320)*p5imp(i,3)));
    p5impg(i)=100*(1-(varimp5/vartor3));
    
    
end
p5impm=regress(diff_p5_plat_torqueimpm(120:320)',[diff_p5_foot_posm(120:320)' diff_p5_foot_velm(120:320)' diff_p5_foot_accm(120:320)']);
C=[diff_p5_foot_posm(120:320)' diff_p5_foot_velm(120:320)' ...
    diff_p5_foot_accm(120:320)'];
d=diff_p5_plat_torqueimpm(120:320)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*lim;l_lim];
...
for i=1:analysis_value-1
    C1=[diff_p6_foot_pos(i,120:320)' diff_p6_foot_vel(i,120:320)'...
        diff_p6_foot_acc(i,120:320)'];
    d1=diff_p6_plat_torqueimp(i,120:320)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*lim;l_lim];
    ...
    vartor3=var(diff_p6_plat_torqueimp(i,120:320));
    varimp6=var(diff_p6_plat_torqueimp(i,120:320)-...
        (diff_p6_foot_pos(i,120:320)*p6imp(i,1)+...
        diff_p6_foot_vel(i,120:320)*p6imp(i,2)+...
        diff_p6_foot_acc(i,120:320)*p6imp(i,3)));
    p6impg(i)=100*(1-(varimp6/vartor3));
    
end
p6impm=regress(diff_p6_plat_torqueimpm(120:320)',...
    [diff_p6_foot_posm(120:320)' diff_p6_foot_velm(120:320)' ...
    diff_p6_foot_accm(120:320)']);

C=[diff_p6_foot_posm(120:320)' diff_p6_foot_velm(120:320)'...
    diff_p6_foot_accm(120:320)'];
d=diff_p6_plat_torqueimpm(120:320)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*lim;l_lim];
