...
for i=1:BOOTSTRAPPING_LOOPS
    ...
    C=[p_bunch1(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' v_bunch1(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' a_bunch1(REGRESSION_START_INDEX:REGRESSION_END_INDEX)'];
    d=bunch1(REGRESSION_START_INDEX:REGRESSION_END_INDEX)';
    ...
    C=[p_bunch2(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' v_bunch2(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' a_bunch2(REGRESSION_START_INDEX:REGRESSION_END_INDEX)'];
    d=bunch2(REGRESSION_START_INDEX:REGRESSION_END_INDEX)';
    A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
    ...
    C=[p_bunch3(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' v_bunch3(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' a_bunch3(REGRESSION_START_INDEX:REGRESSION_END_INDEX)'];
    d=bunch3(REGRESSION_START_INDEX:REGRESSION_END_INDEX)';
    A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
    ...
    C=[p_bunch4(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' v_bunch4(REGRESSION_START_INDEX:REGRESSION_END_INDEX)' a_bunch4(REGRESSION_START_INDEX:REGRESSION_END_INDEX)'];
    d=bunch4(REGRESSION_START_INDEX:REGRESSION_END_INDEX)';
    A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
