...
data_table = table(imp_vals_bs(:, 1), imp_vals_bs(:, 2), imp_vals_bs(:, 3), ...
                   ...
                   pre_diff_selection_count, remaining_after_VAF, ...
...
save(strcat(RESULTS_DIR, sub_name, "_bootstrap_vars.mat"), ...
     'bio_factors_p1', 'bio_factors_p2', 'bio_factors_p3', 'bio_factors_p4', ...
     'regress_coeffs_p1', 'regress_coeffs_p2', 'regress_coeffs_p3', 'regress_coeffs_p4');
 
%% ---- Save Effective shape results ---- %%
save(strcat(RESULTS_DIR, sub_name, "_effective_shape_mat.mat"), "nominal_ROC", ...
     "nominal_EFF_SHAPE_x", "nominal_EFF_SHAPE_y", "transf_pts");