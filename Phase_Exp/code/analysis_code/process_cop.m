...
ci1=prctile(cop_p1,[2.5 97.5]);
ci2=prctile(cop_p2,[2.5 97.5]);
ci3=prctile(cop_p3,[2.5 97.5]);
ci4=prctile(cop_p4,[2.5 97.5]);

CI_coeff1 = ci1(2) - mean(cop_p1);
CI_coeff2 = ci2(2) - mean(cop_p2);
CI_coeff3 = ci3(2) - mean(cop_p3);
CI_coeff4 = ci4(2) - mean(cop_p4);

cop_m = [mean(cop_p1), mean(cop_p2), mean(cop_p3), mean(cop_p4)];
cop_s = [CI_coeff1, CI_coeff2, CI_coeff3, CI_coeff4];
