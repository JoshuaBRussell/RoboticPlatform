...
%platform
for i=1:analysis_value-1
    C1=[diff_p1_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
    d1=diff_p1_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)';
    ...
    vartor3=var(diff_p1_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX));
    varimp3=var(diff_p1_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)-(diff_p1_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p1imp(i,1)+diff_p1_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p1imp(i,2)+diff_p1_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p1imp(i,3)));
    p1impg(i)=100*(1-(varimp3/vartor3));
end

p1impm=regress(diff_p1_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)',[diff_p1_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' ]);
C=[diff_p1_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p1_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
d=diff_p1_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)';
...
for i=1:analysis_value-1
    ...
    C1=[diff_p2_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
    d1=diff_p2_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
    ...
    vartor3=var(diff_p2_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX));
    varimp3=var(diff_p2_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)-(diff_p2_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p2imp(i,1)+diff_p2_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p2imp(i,2)+diff_p2_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p2imp(i,3)));
    p2impg(i)=100*(1-(varimp3/vartor3));
    
end
p2impm=regress(diff_p2_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)',[diff_p2_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)']);
C=[diff_p2_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p2_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
d=diff_p2_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
...
for i=1:analysis_value-1
    ...
    C1=[diff_p3_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
    d1=diff_p3_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
    ...
    vartor3=var(diff_p3_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX));
    varimp3=var(diff_p3_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)-(diff_p3_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p3imp(i,1)+diff_p3_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p3imp(i,2)+diff_p3_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p3imp(i,3)));
    p3impg(i)=100*(1-(varimp3/vartor3));
end

p3impm=regress(diff_p3_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)',[diff_p3_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)']);

C=[diff_p3_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p3_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
d=diff_p3_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
...
for i=1:analysis_value-1
    ...
    C1=[diff_p4_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
    d1=diff_p4_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)';
    A1=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
    B1=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
    ...
    vartor3=var(diff_p4_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX));
    varimp4=var(diff_p4_plat_torqueimp(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)-(diff_p4_foot_pos(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p4imp(i,1)+diff_p4_foot_vel(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p4imp(i,2)+diff_p4_foot_acc(i,REGRESSION_START_INDEX:REGRESSION_END_INEX)*p4imp(i,3)));
    p4impg(i)=100*(1-(varimp4/vartor3));
    
end
p4impm=regress(diff_p4_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)',[diff_p4_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)']);
C=[diff_p4_foot_posm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_velm(REGRESSION_START_INDEX:REGRESSION_END_INEX)' diff_p4_foot_accm(REGRESSION_START_INDEX:REGRESSION_END_INEX)'];
d=diff_p4_plat_torqueimpm(REGRESSION_START_INDEX:REGRESSION_END_INEX)';
A=[-1 0 0;0 -1 0;1 0 0;0 1 0;0 0 -1; 0 0 1];
B=[0 ;0 ;1000;1000;-1*INERTIAL_LOWER_LIM;INERTIAL_UPPER_LIMIT];
